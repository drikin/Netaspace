...
export const releaseNotes: ReleaseNote[] = [
  {
    id: "2025-06-13-v2.6.0",
    version: "2.6.0",
    date: "2025年6月13日",
    title: "エキサイティングなUI改善とパフォーマンス最適化",
    description: "投票ボタンを魅力的なアニメーション付きデザインに刷新し、投票数に基づく視覚的階層システムを実装しました。また、データベースパフォーマンスを65%向上させ、より快適な操作体験を提供します。",
    features: [
      "魅力的な投票ボタンデザイン（グラデーション、アニメーション、パーティクル効果）",
      "投票数に基づく背景色の段階的変化（backspace.fmテーマグリーン）",
      "投票済み状態の視覚的フィードバック強化（シマー、バウンス、パルス効果）",
      "管理タブの表示ロジック修正（管理ページでのみ表示）",
      "データベースクエリ最適化による65%のレスポンス向上（400-700ms）",
      "JOIN クエリとN+1問題解決によるパフォーマンス改善",
      "接続プール最適化とスロークエリ検出機能",
      "ユーザビリティとアクセシビリティの大幅向上"
    ],
    isNew: true
  },
  {
