    ...
    <header className="bg-white shadow-sm sticky top-0 z-10">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <nav className="hidden sm:ml-8 sm:flex sm:items-center space-x-6">
              ...
              <Link 
                href="/list"
                className={`inline-flex items-center px-3 py-2 border-b-2 ${isActive("/list") ? "border-primary text-gray-900 font-medium" : "border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300"} text-sm`}
              >
                一覧表示
              </Link>
            </nav>
      ...
      <div className={`sm:hidden ${mobileMenuOpen ? "" : "hidden"}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link 
            href="/list"
            className={`block pl-3 pr-4 py-2 border-l-4 ${isActive("/list") ? "border-primary bg-primary-50 text-primary-700" : "border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800"} text-base font-medium`}
          >
            一覧表示
          </Link>
        </div>
